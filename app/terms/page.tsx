      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">4.1 Free Trial</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">4.2 ShipNotes Pro</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">4.4 Refund Policy</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">4.5 Cancellation</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">6.3 Generated Changelogs</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">11. Data and Privacy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <div className="mt-4 p-4 border border-border rounded-lg">
              <p className="text-muted-foreground">
                Email: <a href="mailto:legal@shipnotes.xyz" className="text-primary hover:underline">legal@shipnotes.xyz</a>
              </p>
              <p className="text-muted-foreground mt-2">
                Support: <a href="mailto:support@shipnotes.xyz" className="text-primary hover:underline">support@shipnotes.xyz</a>
              </p>
              <p className="text-muted-foreground mt-2">
                Website: <a href="https://shipnotes.xyz" className="text-primary hover:underline">https://shipnotes.xyz</a>
              </p>
            </div>
          </section>
